...
const DESIGN_WORKS_ITEMS = [
  ...
  {
    id: 'hyper-dashboard',
    title: 'THE HYPER DASHBOARD',
    category: 'DESIGN SYSTEM',
    bgStyle: 'hyper',
  },
  {
    id: 'ecommerce-glass',
    title: 'THE E-COMMERCE GLASS',
    category: 'MOBILE APP',
    bgStyle: 'ecommerce',
  },
  {
    id: 'fintech-portal',
    title: 'THE FINTECH PORTAL',
    category: 'WEB APP',
    bgStyle: 'fintech',
  },
];
    ...
    <main className="desktop-content">
      ...
      <section className="desktop-section hero-section" id="hero">
        ...
        <div className="hero-corner hero-corner--top-left">
          <span className="hero-corner__text">2024 — 2026</span>
        </div>

        <div className="hero-corner hero-corner--top-right">
          <span className="hero-corner__text">&#123; FULL STACK DEVELOPER &#125;</span>
        </div>
        ...
        <div className="hero-actions-container">
          <button className="hero-btn hero-btn--maroon" onClick={() => onOpenWindow?.('projects')}>
            <span>🚀 Explore Works</span>
          </button>
          <button className="hero-btn hero-btn--glass" onClick={() => onOpenWindow?.('terminal')}>
            <span>💻 Launch Terminal</span>
          </button>
          <button className="hero-btn hero-btn--glass" onClick={() => onOpenWindow?.('contact')}>
          ...
          <div className="design-works-stage">
            {DESIGN_WORKS_ITEMS.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={`design-card__bg design-card__bg--${item.bgStyle}`}>
          ...
          <div className="skill-window">
            ...
            <div className="skill-window__body">
              ...
              <div className="languages-badge-box">
                ...
                <p className="lang-text">Assamese • English • Hindi • Sanskrit</p>
              </div>
            </div>
          </div>
